...
import { createTextStack, createRenderMeta, createRenderOptions, defaultMarkdownConfig, } from "./types.js";
describe("types", () => {
    ...
    describe("defaultMarkdownConfig", () => {
        ...
        it("should be a MarkdownConfig", () => {
            const config = defaultMarkdownConfig;
    ...
    describe("type definitions", () => {
        ...
        it("StyleHint should accept classic and one", () => {
            const meta1 = createRenderMeta({ styleHint: "classic" });
            const meta2 = createRenderMeta({ styleHint: "one" });
