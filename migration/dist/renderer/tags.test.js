...
import { splitFirstSpace, splitByTags, splitTagByPipe, splitEqualityByPipe, createPipeSplitter, stripTags, hasTags, isTag, getTagName, getTagContent, parseTag, buildTag, builtInTags, defaultTagInfo, createSimpleTagInfo, createDiceTagInfo, } from "./tags.js";
describe("tags", () => {
    ...
    describe("splitByTags", () => {
        ...
        it("should return empty array for null/undefined", () => {
            expect(splitByTags(null)).toEqual([]);
            expect(splitByTags(undefined)).toEqual([]);
        });
    ...
    describe("stripTags", () => {
        ...
        it("should strip tag and preserve surrounding text", () => {
            expect(stripTags("You can cast {@spell fireball} at will.")).toBe("You can cast fireball at will.");
        });
    ...
    describe("hasTags", () => {
        ...
        it("should return false for null/undefined", () => {
            ...
            expect(hasTags(undefined)).toBe(false);
        });
    ...
    describe("buildTag", () => {
        ...
        it("should build tag with display text", () => {
            expect(buildTag("spell", "fireball", "phb", "Big Boom")).toBe("{@spell fireball|phb|Big Boom}");
        });
