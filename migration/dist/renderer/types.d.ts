 ...
 */
export declare const createTextStack: () => TextStack;
/**
 * Create a new RenderMeta with default values.
 */
export declare const createRenderMeta: (overrides?: Partial<RenderMeta>) => RenderMeta;
/**
 * Create a new RenderOptions with default values.
 */
export declare const createRenderOptions: (overrides?: Partial<RenderOptions>) => RenderOptions;
