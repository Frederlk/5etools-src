...
import { uppercaseFirst, lowercaseFirst, toTitleCase, padNumber, ellipsisTruncate, escapeQuotes, unescapeQuotes, qq, uq, encodeApos, toUrlified, escapeRegexp, isNumeric, last, toCamelCase, toSentenceCase, toChunks, toAscii, trimChar, trimAnyChar, countSubstring, distance, toSingle, toPlural, getNextDuplicateName, COMMAS_NOT_IN_PARENTHESES_REGEX, COMMA_SPACE_NOT_IN_PARENTHESES_REGEX, SEMICOLON_SPACE_NOT_IN_PARENTHESES_REGEX, } from "./str-util.js";
describe("str-util", () => {
    ...
    describe("escapeQuotes / unescapeQuotes", () => {
        it("should escape HTML entities", () => {
            expect(escapeQuotes("<div class=\"test\">It's & fine</div>")).toBe("&lt;div class=&quot;test&quot;&gt;It&apos;s &amp; fine&lt;/div&gt;");
        });
        it("should unescape HTML entities", () => {
            expect(unescapeQuotes("&lt;div&gt;&amp;&apos;&quot;&lt;/div&gt;")).toBe("<div>&'\"</div>");
        });
    ...
    describe("toSentenceCase", () => {
        ...
        it("should handle different punctuation", () => {
            expect(toSentenceCase("hello! how are you? fine.")).toBe("Hello! How are you? Fine.");
        });
    });
    describe("toChunks", () => {
...
//# sourceMappingURL=str-util.test.js.map