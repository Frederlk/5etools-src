...
describe("attributes", () => {
	...
	describe("attAbvToFull", () => {
		...
		it("should throw TypeError for null or undefined", () => {
			expect(() => attAbvToFull(null as unknown as string)).toThrow(TypeError);
			expect(() => attAbvToFull(undefined as unknown as string)).toThrow(TypeError);
		});
	});
	...
	describe("attFullToAbv", () => {
		...
		it("should throw TypeError for null or undefined", () => {
			expect(() => attFullToAbv(null as unknown as string)).toThrow(TypeError);
			expect(() => attFullToAbv(undefined as unknown as string)).toThrow(TypeError);
		});
	});
	...
	describe("attrChooseToFull", () => {
		...
		it("should return empty string for null/undefined", () => {
			expect(attrChooseToFull(null as unknown as [])).toBe("");
			expect(attrChooseToFull(undefined as unknown as [])).toBe("");
		});
	});
