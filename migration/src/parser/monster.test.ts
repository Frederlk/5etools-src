...
describe("monster", () => {
	...
	describe("sizeAbvToFull", () => {
		...
		it("should throw TypeError for null or undefined", () => {
			expect(() => sizeAbvToFull(null as unknown as string)).toThrow(TypeError);
			expect(() => sizeAbvToFull(undefined as unknown as string)).toThrow(TypeError);
		});
	});
