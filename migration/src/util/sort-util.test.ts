...
import {
	...
	ascSortLower,
	ascSortLowerProp,
	ascSortNumericalSuffix,
	ascSortLowerPropNumeric,
	ascSortDate,
	ascSortDateString,
	compareListNames,
	ascSortAtts,
...
describe("sort-util", () => {
	...
	describe("ascSortLowerPropNumeric", () => {
		...
		it("should cache _sortName", () => {
			const item = { name: "Test 5" } as { name: string; _sortName?: string };
	...
	describe("ascSortDateString", () => {
		...
		it("should handle null values", () => {
			const arr = ["2020-01-01", null, "2019-01-01"] as (string | null)[];
			arr.sort(ascSortDateString);
